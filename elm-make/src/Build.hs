...
data Result
    ...
    | Success ModuleID Module.Interface ByteString String ThreadId
                ...
                case checkPorts env moduleID interface of
                  ...
                  Nothing ->
                    do  threadId <- myThreadId
                        return (Success moduleID interface ast js threadId)
